...
uninstall:
	...
	${S} echo "${OUR_NAME}: make $@ starting"
	${S} echo
	${S} ${RM} -f ${RM_V} ${DEST_LIB}/libdbg.a
	${S} ${RM} -f ${RM_V} ${DEST_LIB}/dbg.a
	${S} ${RM} -f ${RM_V} ${DEST_DIR}/dbg_example
	${S} ${RM} -f ${RM_V} ${DEST_DIR}/dbg_test
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/dbg.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/err.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/msg.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/warn.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/werr.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/printf_usage.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/warn_or_err.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/errp.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/fdbg.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/ferr.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/ferrp.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/fmsg.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/fprintf_usage.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/fwarn.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/fwarn_or_err.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/fwarnp.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/fwerr.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/fwerrp.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/sndbg.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/snmsg.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/snwarn.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/snwarnp.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/snwerr.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/snwerrp.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vdbg.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/verr.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/verrp.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vfdbg.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vferr.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vferrp.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vfmsg.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vfprintf_usage.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vfwarn.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vfwarn_or_err.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vfwarnp.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vfwerr.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vfwerrp.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vmsg.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vprintf_usage.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vsndbg.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vsnmsg.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vsnwarn.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vsnwarnp.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vsnwerr.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vsnwerrp.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vwarn.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vwarn_or_err.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vwarnp.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vwerr.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/vwerrp.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/warnp.3
	${S} ${RM} -f ${RM_V} ${MAN3_DIR}/werrp.3
